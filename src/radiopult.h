...
private:
    ...
    /* структура пакета данных от пульта управления
        msg[0]  - назначение протокола данных
            0 - данные управления с пульта главного пилота
            1 - данные управления с пульта второго пилота
            2 - данные управления с пульта третьего пилота
            ----
            5 - данные управления с пульта третьего пилота
            6 - запрос на получение параметров модели для графического экрана пульта
